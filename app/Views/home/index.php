            ...
            <div class="product-card hover-lift">
                <div class="product-image">
                    ...
                    <div class="product-actions">
                        <button class="product-action wishlist-btn" data-product-id="<?= $product['id'] ?>"
                            title="Add to Wishlist" onclick="toggleWishlist(<?= $product['id'] ?>)">
                            <i class="far fa-heart"></i>
                        </button>
                        <button class="product-action add-to-cart" data-product-id="<?= $product['id'] ?>"
                            title="Add to Cart">
                            <i class="fas fa-shopping-cart"></i>
                        </button>
                        <a href="<?= $this->url('/product/' . $product['slug']) ?>" class="product-action"
                            title="Quick View">
                ...
                <div class="product-info">
                    <div class="product-category"><?= $this->escape($product['category_name'] ?? 'Uncategorized') ?>
                    </div>
                ...
                <a href="<?= $this->url('/category/' . $category['slug']) ?>" class="category-link">
                    <div class="category-image">
                        <img src="<?= $this->asset('images/categories/' . ($category['image'] ?: 'placeholder.jpg')) ?>"
                            alt="<?= $this->escape($category['name']) ?>" loading="lazy">
...
<section class="newsletter section-padding bg-primary">
    <div class="container">
        <div class="newsletter-content text-center">
            ...
            <p class="newsletter-subtitle">Subscribe to our newsletter and get the latest updates on new products and
                exclusive offers.</p>
            <form class="newsletter-form-inline" action="<?= $this->url('/newsletter/subscribe') ?>" method="POST">
                <input type="hidden" name="csrf_token" value="<?= $csrf_token ?>">
                <div class="newsletter-input-group">
                    <input type="email" name="email" placeholder="Enter your email address"
                        class="newsletter-input-large" required>
